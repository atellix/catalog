...
exports.ObjectBuilder = exports.isBeginningOfDay = exports.getBeginningOfDay = void 0;
const uuid_1 = require("uuid");
const n3_1 = __importDefault(require("n3"));
const { namedNode, literal, quad } = n3_1.default.DataFactory;
...
exports.isBeginningOfDay = isBeginningOfDay;
class ObjectBuilder {
    constructor(defs) {
        this.defs = defs;
        this.typeDefs = {};
    ...
    buildObject(store, propertyDef, dval, cache, baseUri) {
        ...
        if ('id' in dval) {
            ...
            subItemUri = baseUri + '#' + (0, uuid_1.v4)();
        }
    ...
    buildResource(store, type, node, obj, cache, baseUri = '') {
        ...
        Object.entries(allProps).forEach(([key, value]) => {
            ...
            if (value.isArray && dval.length > 1) {
                const itemList = namedNode(baseUri + '#' + (0, uuid_1.v4)());
                ...
                for (var i = 0; i < dval.length; i++) {
                    const itemUri = baseUri + '#' + (0, uuid_1.v4)();
